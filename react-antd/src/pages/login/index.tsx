  ...
  return (
    <div className="w-full h-screen relative bg-[url('@/assets/img/bg2.jpg')] bg-no-repeat bg-cover">
      ...
      <div className="flex items-center absolute top-10 left-[60px]">
        ...
        <span className="text-[26px] font-semibold text-black mx-[10px]">
          |
        </span>
      ...
      <div className="absolute flex flex-col items-center top-[180px] left-[180px] w-[580px] text-black">
        ...
        <div className="text-lg mb-[6px] tracking-[6px]">
          让天下没有难教的孩子
        </div>
        <div className="text-lg mb-[6px] tracking-[6px]">
          让天下没有难读的书
      ...
      <div className="absolute top-[137px] right-[94px] w-[420px] p-[50px_35px_20px_35px] rounded-[10px] bg-[rgba(45,59,104,0.6)]">
        ...
        >
          <Form.Item className="mb-6" name="username">
            <Input
              prefix={<UserOutlined className="text-[#eee]" />}
              placeholder="用户名"
              size="large"
              className="bg-[rgba(0,0,0,0.1)] border-[rgba(255,255,255,0.1)] [&>input]:text-white [&>input]:bg-transparent [&>input::placeholder]:text-[#eee]"
            />
          </Form.Item>
          ...
          >
            <Input.Password
              prefix={<LockOutlined className="text-[#eee]" />}
              placeholder="密码"
              size="large"
              className="bg-[rgba(0,0,0,0.1)] border-[rgba(255,255,255,0.1)] [&>input]:text-white [&>input]:bg-transparent [&>input::placeholder]:text-[#eee] [&_.ant-input-password-icon]:text-[#eee]"
            />
          </Form.Item>
